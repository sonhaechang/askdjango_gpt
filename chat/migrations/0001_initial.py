# Generated by Django 4.2.1 on 2024-04-06 14:33
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='%(class)s_user_set', to=settings.AUTH_USER_MODEL, verbose_name='사용자')),
            ],
            options={
                'verbose_name': '상항극 채팅방',
                'verbose_name_plural': '상항극 채팅방',
